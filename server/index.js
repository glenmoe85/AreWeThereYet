...
app.put("/api/update_event/:id", (req, res) => {
	...
	console.log(event_id, title, start_date, end_date, county, city, formUrl, formDescription, age_group, price, image)
...
app.post("/api/new_event", (req, res) => {
	...
	console.log(organizer_id, title, start_date, end_date, county, city, formUrl, formDescription, age_group, price, image)
